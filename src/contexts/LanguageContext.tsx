...
const translations = {
  en: {
    ...
    'hero.subtitle': 'The ultimate 4-in-1 emergency solution: Battery charger, jump starter, flashlight, and power bank all in one compact device.',
  ...
  ar: {
    ...
    'hero.subtitle': 'الحل الطارئ الأمثل 4 في 1: شاحن بطارية، مشغل سيارة، كشاف، وباور بانك في جهاز واحد مدمج.',
    ...
    'product.warranty': 'ضمان سنة واحدة',
